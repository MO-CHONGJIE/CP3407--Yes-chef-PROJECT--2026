...
The core objective of Yes-chef-PROJECT is:

Provide a fully functional and user-friendly online food ordering platform

Through AI recommendation algorithms, it helps users quickly find the most suitable dishes for themselves

Improve the efficiency and satisfaction of users' ordering, and at the same time help merchants increase their conversion rate
